...
class DeepVOErrorRegression(BaseModel):
    def __init__(
        self, 
        img_h, 
        img_w, 
        ...
        self.linear_1 = nn.Linear(in_features=rnn_hidden_size, out_features=1)
        self.linear_2 = nn.Linear(in_features=rnn_hidden_size, out_features=1)
    ...
    def get_loss(self, batch: Tuple[Any, ...]) -> torch.Tensor:
        ...
        _, x, y_trans_mag, y_rot_mag = batch
